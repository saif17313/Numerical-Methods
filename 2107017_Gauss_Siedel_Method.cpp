...
int main()
{
  double a1,b1,c1,d1,a2,b2,c2,d2,a3,b3,c3,d3,x1,y1,z1,x,y,z,p,q,r;
  ...
  int cnt=1;
  x1=0; y1=0; z1=0;
  const double maxTl=0.001;
  while(true)
  {
      x=(d1-(b1*y1+c1*z1))/a1; p=abs(x-x1); x1=x;
      y=(d2-(a2*x1+c2*z1))/b2; q=abs(y-y1); y1=y;
      z=(d3-(a3*x1+b3*y1))/c3; r=abs(z-z1); z1=z;
